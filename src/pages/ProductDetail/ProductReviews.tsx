...
// //             </Text>
// //           </div>
// //         } style={{ padding: 40, background: '#fafafa', borderRadius: 8 }} />
// //       ) : (
// //         <List
// //           itemLayout="vertical"
// //           dataSource={reviews}
// //           renderItem={(review) => <ReviewCard key={review.id} review={review} baseUrl={baseUrl} />}
...
// // const ReviewCard: React.FC<{ review: ReviewResponse; baseUrl: string }> = ({ review, baseUrl }) => {
// //   const reviewDate = new Date(review.reviewDate);
...
// //             <div>
// //               <Text strong style={{ fontSize: 16 }}>{review.customer?.fullName || 'Anonymous'}</Text>
// //               <div><Text type="secondary" style={{ fontSize: 12 }}>{review.customer?.email}</Text></div>
// //             </div>
// //             <div style={{ textAlign: 'right' }}>
// //               <div style={{ fontSize: 12, color: '#777' }}><CalendarOutlined /> {formattedDate}</div>
// //               <div style={{ marginTop: 8 }}>
// //                 <Tag color={review.isApproved ? 'green' : 'orange'}>{review.isApproved ? 'Approved' : 'Pending'}</Tag>
...
// //             <Text strong style={{ marginLeft: 8 }}>{review.rating}.0</Text>
// //           </div>

// //           <Paragraph style={{ marginTop: 12 }}>{review.comment || 'No comment provided.'}</Paragraph>

// //           {review.reviewImages && review.reviewImages.length > 0 && (
// //             <div style={{ marginTop: 12 }}>
// //               <Text strong><PictureOutlined /> Customer Photos ({review.reviewImages.length})</Text>
...
// //                       preview={{ mask: <div style={{ color: 'white' }}><EyeOutlined /> View</div> }}
