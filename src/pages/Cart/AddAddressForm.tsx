...
const AddAddressForm: React.FC<AddAddressFormProps> = ({
  ...
  const validateForm = () => {
    ...
    if (!formData.addressName.trim()) {
      newErrors.addressName = 'Please enter the address name';
    }
    ...
    if (!formData.fullAddress.trim()) {
      newErrors.fullAddress = 'Please enter the full address';
    }
          ...
          <form onSubmit={handleSubmit} className="address-form">
            ...
            <div className="form-group">
              ...
              <textarea
                  ...
                  onChange={handleInputChange}
                  placeholder="Enter full address (house number, street, ward, district, city/province)"
                  rows={3}
